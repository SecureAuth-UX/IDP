(function (factory) {
  ...
  $.extend(true, $.fn.dataTable.defaults, {
    "sDom": "frt<'d-flex justify-content-end w-100' lip>",
  ...
  $.extend($.fn.dataTableExt.oPagination, {
    "bs_normal": {
      "fnInit": function (oSettings, nPaging, fnDraw) {
        ...
        $(nPaging).append(
          '<ul class="pagination">' +
          '<li class="prev disabled"><a href="#"><svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">' +
          '<path d="M12.0038 12.4352L8.56879 9.00024L12.0038 5.55774L10.9463 4.50024L6.44629 9.00024L10.9463 13.5002L12.0038 12.4352Z" fill="#2A2E2F"/>' +
          '</svg>' +
          '</a></li>' +
          '<li class="next disabled"><a href="#">' +
          '<svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">' +
          '<path d="M6.88867 12.4352L10.3237 9.00024L6.88867 5.55774L7.94617 4.50024L12.4462 9.00024L7.94617 13.5002L6.88867 12.4352Z" fill="#2A2E2F"/>' +
          '</svg>' +
          '</a></li>' +
          '</ul>'
        );
